...
USE data_db,ONLY: beame, beame_head, beame_sets, beame_nodes, label
IMPLICIT NONE
 ...
 DO iset=1,beame_sets            !for each element set
   sname = TRIM(e%sname)
   CALL prtcob(e%nnode,1,sname,beame_nodes(1,2),iset)        !write coordinates and headers
