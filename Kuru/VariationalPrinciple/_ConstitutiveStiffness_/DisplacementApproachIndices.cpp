...
#define __PYX_HAVE__DisplacementApproachIndices
#define __PYX_HAVE_API__DisplacementApproachIndices
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "DisplacementApproachIndices.pyx",
  "__init__.pxd",
  "type.pxd",
};
...
/* Module declarations from 'DisplacementApproachIndices' */
static CYTHON_INLINE void __pyx_f_27DisplacementApproachIndices_FillConstitutiveB_(double *, double const *, int, int, int, int); /*proto*/
static CYTHON_INLINE void __pyx_f_27DisplacementApproachIndices_FillGeometricB_(double *, double *, double *, double *, int, int, int, int); /*proto*/
static CYTHON_INLINE void __pyx_f_27DisplacementApproachIndices_GetTotalTraction_(double *, double const *, int); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "DisplacementApproachIndices"
extern int __pyx_module_is_main_DisplacementApproachIndices;
int __pyx_module_is_main_DisplacementApproachIndices = 0;

/* Implementation of 'DisplacementApproachIndices' */
...
static const char __pyx_k_DisplacementApproachIndices[] = "DisplacementApproachIndices";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_DisplacementApproachIndices_pyx[] = "DisplacementApproachIndices.pyx";
...
static PyObject *__pyx_n_s_DisplacementApproachIndices;
static PyObject *__pyx_kp_s_DisplacementApproachIndices_pyx;
...
static PyObject *__pyx_pf_27DisplacementApproachIndices_FillConstitutiveB(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_B, PyArrayObject *__pyx_v_SpatialGradient, int __pyx_v_ndim, int __pyx_v_nvar); /* proto */
static PyObject *__pyx_pf_27DisplacementApproachIndices_2FillGeometricB(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_B, PyArrayObject *__pyx_v_SpatialGradient, PyArrayObject *__pyx_v_S, PyArrayObject *__pyx_v_CauchyStressTensor, int __pyx_v_ndim, int __pyx_v_nvar); /* proto */
static PyObject *__pyx_pf_27DisplacementApproachIndices_4GetTotalTraction(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_CauchyStressTensor); /* proto */
...
/* "DisplacementApproachIndices.pyx":5
...
static CYTHON_INLINE void __pyx_f_27DisplacementApproachIndices_FillConstitutiveB_(double *__pyx_v_B, double const *__pyx_v_SpatialGradient, int __pyx_v_ndim, int __pyx_v_nvar, int __pyx_v_rows, int __pyx_v_cols) {
  int __pyx_v_i;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;

  /* "DisplacementApproachIndices.pyx":9
 *     cdef int i
 * 
 *     if ndim == 2:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  switch (__pyx_v_ndim) {
    ...
    /* "DisplacementApproachIndices.pyx":11
 *     if ndim == 2:
 * 
 *         for i in range(rows):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "DisplacementApproachIndices.pyx":12
 * 
 *         for i in range(rows):
 *             B[i*cols*nvar] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar+cols+1] = SpatialGradient[i+rows]
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":13
 *         for i in range(rows):
 *             B[i*cols*nvar] = SpatialGradient[i]
 *             B[i*cols*nvar+cols+1] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":19
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":20
 * 
 *             B[i*cols*nvar+2] = SpatialGradient[i+rows]
 *             B[i*cols*nvar+cols+2] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":24
 *     elif ndim == 3:
 * 
 *         for i in range(rows):             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar] = SpatialGradient[i]
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "DisplacementApproachIndices.pyx":25
 * 
 *         for i in range(rows):
 *             B[i*cols*nvar] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar+cols+1] = SpatialGradient[i+rows]
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":26
 *         for i in range(rows):
 *             B[i*cols*nvar] = SpatialGradient[i]
 *             B[i*cols*nvar+cols+1] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar+2*(cols+1)] = SpatialGradient[i+2*rows]
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":27
 *             B[i*cols*nvar] = SpatialGradient[i]
 *             B[i*cols*nvar+cols+1] = SpatialGradient[i+rows]
 *             B[i*cols*nvar+2*(cols+1)] = SpatialGradient[i+2*rows]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":29
 *             B[i*cols*nvar+2*(cols+1)] = SpatialGradient[i+2*rows]
 * 
 *             B[i*cols*nvar+cols+5] = SpatialGradient[i+2*rows]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":30
 * 
 *             B[i*cols*nvar+cols+5] = SpatialGradient[i+2*rows]
 *             B[i*cols*nvar+2*cols+5] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":32
 *             B[i*cols*nvar+2*cols+5] = SpatialGradient[i+rows]
 * 
 *             B[i*cols*nvar+4] = SpatialGradient[i+2*rows]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":33
 * 
 *             B[i*cols*nvar+4] = SpatialGradient[i+2*rows]
 *             B[i*cols*nvar+2*cols+4] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":35
 *             B[i*cols*nvar+2*cols+4] = SpatialGradient[i]
 * 
 *             B[i*cols*nvar+3] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":36
 * 
 *             B[i*cols*nvar+3] = SpatialGradient[i+rows]
 *             B[i*cols*nvar+cols+3] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":22
 *             B[i*cols*nvar+cols+2] = SpatialGradient[i]
 * 
 *     elif ndim == 3:             # <<<<<<<<<<<<<<
 * 
...
/* "DisplacementApproachIndices.pyx":45
 * @boundscheck(False)
 * @wraparound(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_27DisplacementApproachIndices_1FillConstitutiveB(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_27DisplacementApproachIndices_1FillConstitutiveB = {"FillConstitutiveB", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_27DisplacementApproachIndices_1FillConstitutiveB, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_27DisplacementApproachIndices_1FillConstitutiveB(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("FillConstitutiveB (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_SpatialGradient)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("FillConstitutiveB", 1, 4, 4, 1); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndim)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("FillConstitutiveB", 1, 4, 4, 2); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nvar)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("FillConstitutiveB", 1, 4, 4, 3); __PYX_ERR(0, 45, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "FillConstitutiveB") < 0)) __PYX_ERR(0, 45, __pyx_L3_error)
      }
    ...
    __pyx_v_ndim = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_ndim == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 47, __pyx_L3_error)
    __pyx_v_nvar = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_nvar == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 47, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("FillConstitutiveB", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 45, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("DisplacementApproachIndices.FillConstitutiveB", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_B), __pyx_ptype_5numpy_ndarray, 1, "B", 0))) __PYX_ERR(0, 45, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_SpatialGradient), __pyx_ptype_5numpy_ndarray, 1, "SpatialGradient", 0))) __PYX_ERR(0, 46, __pyx_L1_error)
  __pyx_r = __pyx_pf_27DisplacementApproachIndices_FillConstitutiveB(__pyx_self, __pyx_v_B, __pyx_v_SpatialGradient, __pyx_v_ndim, __pyx_v_nvar);
...
static PyObject *__pyx_pf_27DisplacementApproachIndices_FillConstitutiveB(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_B, PyArrayObject *__pyx_v_SpatialGradient, int __pyx_v_ndim, int __pyx_v_nvar) {
  int __pyx_v_rows;
  int __pyx_v_cols;
  ...
  __pyx_pybuffernd_SpatialGradient.rcbuffer = &__pyx_pybuffer_SpatialGradient;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_B.rcbuffer->pybuffer, (PyObject*)__pyx_v_B, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 45, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_SpatialGradient.rcbuffer->pybuffer, (PyObject*)__pyx_v_SpatialGradient, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 45, __pyx_L1_error)
  }
  ...
  /* "DisplacementApproachIndices.pyx":49
 *                      int ndim, int nvar):
 * 
 ...
 */
  ...
  /* "DisplacementApproachIndices.pyx":50
 * 
 *     cdef int rows = SpatialGradient.shape[1]
 *     cdef int cols = B.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "DisplacementApproachIndices.pyx":53
 * 
 * 
 ...
 */
  ...
  /* "DisplacementApproachIndices.pyx":54
 * 
 *     FillConstitutiveB_(&B[0,0],&SpatialGradient[0,0],
 *         ndim,nvar,rows,cols)             # <<<<<<<<<<<<<<
 * 
...
/* "DisplacementApproachIndices.pyx":66
 * 
 * 
...
static CYTHON_INLINE void __pyx_f_27DisplacementApproachIndices_FillGeometricB_(double *__pyx_v_B, double *__pyx_v_SpatialGradient, double *__pyx_v_S, double *__pyx_v_CauchyStressTensor, int __pyx_v_ndim, int __pyx_v_nvar, int __pyx_v_rows, int __pyx_v_cols) {
  int __pyx_v_i;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;

  /* "DisplacementApproachIndices.pyx":71
 *     cdef int i
 * 
 *     if ndim == 2:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  switch (__pyx_v_ndim) {
    ...
    /* "DisplacementApproachIndices.pyx":73
 *     if ndim == 2:
 * 
 *         for i in range(rows):             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar] = SpatialGradient[i]
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "DisplacementApproachIndices.pyx":74
 * 
 *         for i in range(rows):
 *             B[i*cols*nvar] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar+1] = SpatialGradient[i+rows]
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":75
 *         for i in range(rows):
 *             B[i*cols*nvar] = SpatialGradient[i]
 *             B[i*cols*nvar+1] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":77
 *             B[i*cols*nvar+1] = SpatialGradient[i+rows]
 * 
 *             B[i*cols*nvar+(cols+2)] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":78
 * 
 *             B[i*cols*nvar+(cols+2)] = SpatialGradient[i]
 *             B[i*cols*nvar+(cols+2)+1] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":80
 *             B[i*cols*nvar+(cols+2)+1] = SpatialGradient[i+rows]
 * 
 *         S[0] = CauchyStressTensor[0]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":81
 * 
 *         S[0] = CauchyStressTensor[0]
 *         S[1] = CauchyStressTensor[1]             # <<<<<<<<<<<<<<
 *         S[4] = CauchyStressTensor[2]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":82
 *         S[0] = CauchyStressTensor[0]
 *         S[1] = CauchyStressTensor[1]
 *         S[4] = CauchyStressTensor[2]             # <<<<<<<<<<<<<<
 *         S[5] = CauchyStressTensor[3]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":83
 *         S[1] = CauchyStressTensor[1]
 *         S[4] = CauchyStressTensor[2]
 *         S[5] = CauchyStressTensor[3]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":85
 *         S[5] = CauchyStressTensor[3]
 * 
 *         S[10] = CauchyStressTensor[0]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":86
 * 
 *         S[10] = CauchyStressTensor[0]
 *         S[11] = CauchyStressTensor[1]             # <<<<<<<<<<<<<<
 *         S[14] = CauchyStressTensor[2]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":87
 *         S[10] = CauchyStressTensor[0]
 *         S[11] = CauchyStressTensor[1]
 *         S[14] = CauchyStressTensor[2]             # <<<<<<<<<<<<<<
 *         S[15] = CauchyStressTensor[3]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":88
 *         S[11] = CauchyStressTensor[1]
 *         S[14] = CauchyStressTensor[2]
 *         S[15] = CauchyStressTensor[3]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":92
 *     elif ndim == 3:
 * 
 *         for i in range(rows):             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar] = SpatialGradient[i]
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "DisplacementApproachIndices.pyx":93
 * 
 *         for i in range(rows):
 *             B[i*cols*nvar] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar+1] = SpatialGradient[i+rows]
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":94
 *         for i in range(rows):
 *             B[i*cols*nvar] = SpatialGradient[i]
 *             B[i*cols*nvar+1] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar+2] = SpatialGradient[i+2*rows]
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":95
 *             B[i*cols*nvar] = SpatialGradient[i]
 *             B[i*cols*nvar+1] = SpatialGradient[i+rows]
 *             B[i*cols*nvar+2] = SpatialGradient[i+2*rows]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":97
 *             B[i*cols*nvar+2] = SpatialGradient[i+2*rows]
 * 
 *             B[i*cols*nvar+(cols+3)] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":98
 * 
 *             B[i*cols*nvar+(cols+3)] = SpatialGradient[i]
 *             B[i*cols*nvar+(cols+3)+1] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar+(cols+3)+2] = SpatialGradient[i+2*rows]
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":99
 *             B[i*cols*nvar+(cols+3)] = SpatialGradient[i]
 *             B[i*cols*nvar+(cols+3)+1] = SpatialGradient[i+rows]
 *             B[i*cols*nvar+(cols+3)+2] = SpatialGradient[i+2*rows]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":101
 *             B[i*cols*nvar+(cols+3)+2] = SpatialGradient[i+2*rows]
 * 
 *             B[i*cols*nvar+2*(cols+3)] = SpatialGradient[i]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":102
 * 
 *             B[i*cols*nvar+2*(cols+3)] = SpatialGradient[i]
 *             B[i*cols*nvar+2*(cols+3)+1] = SpatialGradient[i+rows]             # <<<<<<<<<<<<<<
 *             B[i*cols*nvar+2*(cols+3)+2] = SpatialGradient[i+2*rows]
 ...
 */
      ...
      /* "DisplacementApproachIndices.pyx":103
 *             B[i*cols*nvar+2*(cols+3)] = SpatialGradient[i]
 *             B[i*cols*nvar+2*(cols+3)+1] = SpatialGradient[i+rows]
 *             B[i*cols*nvar+2*(cols+3)+2] = SpatialGradient[i+2*rows]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":105
 *             B[i*cols*nvar+2*(cols+3)+2] = SpatialGradient[i+2*rows]
 * 
 *         S[0] = CauchyStressTensor[0]             # <<<<<<<<<<<<<<
 *         S[1] = CauchyStressTensor[1]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":106
 * 
 *         S[0] = CauchyStressTensor[0]
 *         S[1] = CauchyStressTensor[1]             # <<<<<<<<<<<<<<
 *         S[2] = CauchyStressTensor[2]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":107
 *         S[0] = CauchyStressTensor[0]
 *         S[1] = CauchyStressTensor[1]
 *         S[2] = CauchyStressTensor[2]             # <<<<<<<<<<<<<<
 *         S[9] = CauchyStressTensor[3]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":108
 *         S[1] = CauchyStressTensor[1]
 *         S[2] = CauchyStressTensor[2]
 *         S[9] = CauchyStressTensor[3]             # <<<<<<<<<<<<<<
 *         S[10] = CauchyStressTensor[4]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":109
 *         S[2] = CauchyStressTensor[2]
 *         S[9] = CauchyStressTensor[3]
 *         S[10] = CauchyStressTensor[4]             # <<<<<<<<<<<<<<
 *         S[11] = CauchyStressTensor[5]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":110
 *         S[9] = CauchyStressTensor[3]
 *         S[10] = CauchyStressTensor[4]
 *         S[11] = CauchyStressTensor[5]             # <<<<<<<<<<<<<<
 *         S[18] = CauchyStressTensor[6]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":111
 *         S[10] = CauchyStressTensor[4]
 *         S[11] = CauchyStressTensor[5]
 *         S[18] = CauchyStressTensor[6]             # <<<<<<<<<<<<<<
 *         S[19] = CauchyStressTensor[7]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":112
 *         S[11] = CauchyStressTensor[5]
 *         S[18] = CauchyStressTensor[6]
 *         S[19] = CauchyStressTensor[7]             # <<<<<<<<<<<<<<
 *         S[20] = CauchyStressTensor[8]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":113
 *         S[18] = CauchyStressTensor[6]
 *         S[19] = CauchyStressTensor[7]
 *         S[20] = CauchyStressTensor[8]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":115
 *         S[20] = CauchyStressTensor[8]
 * 
 *         S[30] = CauchyStressTensor[0]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":116
 * 
 *         S[30] = CauchyStressTensor[0]
 *         S[31] = CauchyStressTensor[1]             # <<<<<<<<<<<<<<
 *         S[32] = CauchyStressTensor[2]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":117
 *         S[30] = CauchyStressTensor[0]
 *         S[31] = CauchyStressTensor[1]
 *         S[32] = CauchyStressTensor[2]             # <<<<<<<<<<<<<<
 *         S[39] = CauchyStressTensor[3]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":118
 *         S[31] = CauchyStressTensor[1]
 *         S[32] = CauchyStressTensor[2]
 *         S[39] = CauchyStressTensor[3]             # <<<<<<<<<<<<<<
 *         S[40] = CauchyStressTensor[4]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":119
 *         S[32] = CauchyStressTensor[2]
 *         S[39] = CauchyStressTensor[3]
 *         S[40] = CauchyStressTensor[4]             # <<<<<<<<<<<<<<
 *         S[41] = CauchyStressTensor[5]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":120
 *         S[39] = CauchyStressTensor[3]
 *         S[40] = CauchyStressTensor[4]
 *         S[41] = CauchyStressTensor[5]             # <<<<<<<<<<<<<<
 *         S[48] = CauchyStressTensor[6]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":121
 *         S[40] = CauchyStressTensor[4]
 *         S[41] = CauchyStressTensor[5]
 *         S[48] = CauchyStressTensor[6]             # <<<<<<<<<<<<<<
 *         S[49] = CauchyStressTensor[7]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":122
 *         S[41] = CauchyStressTensor[5]
 *         S[48] = CauchyStressTensor[6]
 *         S[49] = CauchyStressTensor[7]             # <<<<<<<<<<<<<<
 *         S[50] = CauchyStressTensor[8]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":123
 *         S[48] = CauchyStressTensor[6]
 *         S[49] = CauchyStressTensor[7]
 *         S[50] = CauchyStressTensor[8]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":125
 *         S[50] = CauchyStressTensor[8]
 * 
 *         S[60] = CauchyStressTensor[0]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":126
 * 
 *         S[60] = CauchyStressTensor[0]
 *         S[61] = CauchyStressTensor[1]             # <<<<<<<<<<<<<<
 *         S[62] = CauchyStressTensor[2]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":127
 *         S[60] = CauchyStressTensor[0]
 *         S[61] = CauchyStressTensor[1]
 *         S[62] = CauchyStressTensor[2]             # <<<<<<<<<<<<<<
 *         S[69] = CauchyStressTensor[3]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":128
 *         S[61] = CauchyStressTensor[1]
 *         S[62] = CauchyStressTensor[2]
 *         S[69] = CauchyStressTensor[3]             # <<<<<<<<<<<<<<
 *         S[70] = CauchyStressTensor[4]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":129
 *         S[62] = CauchyStressTensor[2]
 *         S[69] = CauchyStressTensor[3]
 *         S[70] = CauchyStressTensor[4]             # <<<<<<<<<<<<<<
 *         S[71] = CauchyStressTensor[5]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":130
 *         S[69] = CauchyStressTensor[3]
 *         S[70] = CauchyStressTensor[4]
 *         S[71] = CauchyStressTensor[5]             # <<<<<<<<<<<<<<
 *         S[78] = CauchyStressTensor[6]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":131
 *         S[70] = CauchyStressTensor[4]
 *         S[71] = CauchyStressTensor[5]
 *         S[78] = CauchyStressTensor[6]             # <<<<<<<<<<<<<<
 *         S[79] = CauchyStressTensor[7]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":132
 *         S[71] = CauchyStressTensor[5]
 *         S[78] = CauchyStressTensor[6]
 *         S[79] = CauchyStressTensor[7]             # <<<<<<<<<<<<<<
 *         S[80] = CauchyStressTensor[8]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":133
 *         S[78] = CauchyStressTensor[6]
 *         S[79] = CauchyStressTensor[7]
 *         S[80] = CauchyStressTensor[8]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":90
 *         S[15] = CauchyStressTensor[3]
 * 
 *     elif ndim == 3:             # <<<<<<<<<<<<<<
 * 
...
/* "DisplacementApproachIndices.pyx":138
 * @boundscheck(False)
 * @wraparound(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_27DisplacementApproachIndices_3FillGeometricB(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_27DisplacementApproachIndices_3FillGeometricB = {"FillGeometricB", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_27DisplacementApproachIndices_3FillGeometricB, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_27DisplacementApproachIndices_3FillGeometricB(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_B = 0;
  PyArrayObject *__pyx_v_SpatialGradient = 0;
  ...
  __Pyx_RefNannySetupContext("FillGeometricB (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_SpatialGradient)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("FillGeometricB", 1, 6, 6, 1); __PYX_ERR(0, 138, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_S)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("FillGeometricB", 1, 6, 6, 2); __PYX_ERR(0, 138, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_CauchyStressTensor)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("FillGeometricB", 1, 6, 6, 3); __PYX_ERR(0, 138, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ndim)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("FillGeometricB", 1, 6, 6, 4); __PYX_ERR(0, 138, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nvar)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("FillGeometricB", 1, 6, 6, 5); __PYX_ERR(0, 138, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "FillGeometricB") < 0)) __PYX_ERR(0, 138, __pyx_L3_error)
      }
    ...
    __pyx_v_ndim = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_ndim == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 141, __pyx_L3_error)
    __pyx_v_nvar = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_nvar == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 141, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("FillGeometricB", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 138, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("DisplacementApproachIndices.FillGeometricB", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_B), __pyx_ptype_5numpy_ndarray, 1, "B", 0))) __PYX_ERR(0, 138, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_SpatialGradient), __pyx_ptype_5numpy_ndarray, 1, "SpatialGradient", 0))) __PYX_ERR(0, 139, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_S), __pyx_ptype_5numpy_ndarray, 1, "S", 0))) __PYX_ERR(0, 140, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_CauchyStressTensor), __pyx_ptype_5numpy_ndarray, 1, "CauchyStressTensor", 0))) __PYX_ERR(0, 141, __pyx_L1_error)
  __pyx_r = __pyx_pf_27DisplacementApproachIndices_2FillGeometricB(__pyx_self, __pyx_v_B, __pyx_v_SpatialGradient, __pyx_v_S, __pyx_v_CauchyStressTensor, __pyx_v_ndim, __pyx_v_nvar);
...
static PyObject *__pyx_pf_27DisplacementApproachIndices_2FillGeometricB(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_B, PyArrayObject *__pyx_v_SpatialGradient, PyArrayObject *__pyx_v_S, PyArrayObject *__pyx_v_CauchyStressTensor, int __pyx_v_ndim, int __pyx_v_nvar) {
  int __pyx_v_rows;
  int __pyx_v_cols;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_B;
  __Pyx_Buffer __pyx_pybuffer_B;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_B.rcbuffer->pybuffer, (PyObject*)__pyx_v_B, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 138, __pyx_L1_error)
  }
  __pyx_pybuffernd_B.diminfo[0].strides = __pyx_pybuffernd_B.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_B.diminfo[0].shape = __pyx_pybuffernd_B.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_B.diminfo[1].strides = __pyx_pybuffernd_B.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_B.diminfo[1].shape = __pyx_pybuffernd_B.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_SpatialGradient.rcbuffer->pybuffer, (PyObject*)__pyx_v_SpatialGradient, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 138, __pyx_L1_error)
  }
  __pyx_pybuffernd_SpatialGradient.diminfo[0].strides = __pyx_pybuffernd_SpatialGradient.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_SpatialGradient.diminfo[0].shape = __pyx_pybuffernd_SpatialGradient.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_SpatialGradient.diminfo[1].strides = __pyx_pybuffernd_SpatialGradient.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_SpatialGradient.diminfo[1].shape = __pyx_pybuffernd_SpatialGradient.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_S.rcbuffer->pybuffer, (PyObject*)__pyx_v_S, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 138, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_CauchyStressTensor.rcbuffer->pybuffer, (PyObject*)__pyx_v_CauchyStressTensor, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 138, __pyx_L1_error)
  }
  ...
  /* "DisplacementApproachIndices.pyx":143
 ...
 */
  ...
  /* "DisplacementApproachIndices.pyx":144
 * 
 *     cdef int rows = SpatialGradient.shape[1]
 *     cdef int cols = B.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "DisplacementApproachIndices.pyx":146
 *     cdef int cols = B.shape[1]
 * 
 *     FillGeometricB_(&B[0,0],&SpatialGradient[0,0],&S[0,0],             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "DisplacementApproachIndices.pyx":147
 * 
 *     FillGeometricB_(&B[0,0],&SpatialGradient[0,0],&S[0,0],
 *         &CauchyStressTensor[0,0],ndim,nvar,rows,cols)             # <<<<<<<<<<<<<<
 * 
...
/* "DisplacementApproachIndices.pyx":156
 * 
 * 
...
static CYTHON_INLINE void __pyx_f_27DisplacementApproachIndices_GetTotalTraction_(double *__pyx_v_TotalTraction, double const *__pyx_v_CauchyStressTensor, int __pyx_v_ndim) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("GetTotalTraction_", 0);

  /* "DisplacementApproachIndices.pyx":157
 * 
 * cdef inline void GetTotalTraction_(double *TotalTraction, const double *CauchyStressTensor, int ndim):
 *     if ndim == 2:             # <<<<<<<<<<<<<<
 *         TotalTraction[0] = CauchyStressTensor[0]
 ...
 */
  switch (__pyx_v_ndim) {
    ...
    /* "DisplacementApproachIndices.pyx":158
 * cdef inline void GetTotalTraction_(double *TotalTraction, const double *CauchyStressTensor, int ndim):
 *     if ndim == 2:
 *         TotalTraction[0] = CauchyStressTensor[0]             # <<<<<<<<<<<<<<
 *         TotalTraction[1] = CauchyStressTensor[3]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":159
 *     if ndim == 2:
 *         TotalTraction[0] = CauchyStressTensor[0]
 *         TotalTraction[1] = CauchyStressTensor[3]             # <<<<<<<<<<<<<<
 *         TotalTraction[2] = CauchyStressTensor[1]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":160
 *         TotalTraction[0] = CauchyStressTensor[0]
 *         TotalTraction[1] = CauchyStressTensor[3]
 *         TotalTraction[2] = CauchyStressTensor[1]             # <<<<<<<<<<<<<<
 *     elif ndim==3:
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":162
 *         TotalTraction[2] = CauchyStressTensor[1]
 *     elif ndim==3:
 *         TotalTraction[0] = CauchyStressTensor[0]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":163
 *     elif ndim==3:
 *         TotalTraction[0] = CauchyStressTensor[0]
 *         TotalTraction[1] = CauchyStressTensor[4]             # <<<<<<<<<<<<<<
 *         TotalTraction[2] = CauchyStressTensor[8]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":164
 *         TotalTraction[0] = CauchyStressTensor[0]
 *         TotalTraction[1] = CauchyStressTensor[4]
 *         TotalTraction[2] = CauchyStressTensor[8]             # <<<<<<<<<<<<<<
 *         TotalTraction[3] = CauchyStressTensor[1]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":165
 *         TotalTraction[1] = CauchyStressTensor[4]
 *         TotalTraction[2] = CauchyStressTensor[8]
 *         TotalTraction[3] = CauchyStressTensor[1]             # <<<<<<<<<<<<<<
 *         TotalTraction[4] = CauchyStressTensor[2]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":166
 *         TotalTraction[2] = CauchyStressTensor[8]
 *         TotalTraction[3] = CauchyStressTensor[1]
 *         TotalTraction[4] = CauchyStressTensor[2]             # <<<<<<<<<<<<<<
 *         TotalTraction[5] = CauchyStressTensor[5]
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":167
 *         TotalTraction[3] = CauchyStressTensor[1]
 *         TotalTraction[4] = CauchyStressTensor[2]
 *         TotalTraction[5] = CauchyStressTensor[5]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":161
 *         TotalTraction[1] = CauchyStressTensor[3]
 *         TotalTraction[2] = CauchyStressTensor[1]
 *     elif ndim==3:             # <<<<<<<<<<<<<<
 *         TotalTraction[0] = CauchyStressTensor[0]
...
/* "DisplacementApproachIndices.pyx":174
 * @boundscheck(False)
 * @wraparound(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_27DisplacementApproachIndices_5GetTotalTraction(PyObject *__pyx_self, PyObject *__pyx_v_CauchyStressTensor); /*proto*/
static PyMethodDef __pyx_mdef_27DisplacementApproachIndices_5GetTotalTraction = {"GetTotalTraction", (PyCFunction)__pyx_pw_27DisplacementApproachIndices_5GetTotalTraction, METH_O, 0};
static PyObject *__pyx_pw_27DisplacementApproachIndices_5GetTotalTraction(PyObject *__pyx_self, PyObject *__pyx_v_CauchyStressTensor) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("GetTotalTraction (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_CauchyStressTensor), __pyx_ptype_5numpy_ndarray, 1, "CauchyStressTensor", 0))) __PYX_ERR(0, 174, __pyx_L1_error)
  __pyx_r = __pyx_pf_27DisplacementApproachIndices_4GetTotalTraction(__pyx_self, ((PyArrayObject *)__pyx_v_CauchyStressTensor));
...
static PyObject *__pyx_pf_27DisplacementApproachIndices_4GetTotalTraction(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_CauchyStressTensor) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_CauchyStressTensor.rcbuffer->pybuffer, (PyObject*)__pyx_v_CauchyStressTensor, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 174, __pyx_L1_error)
  }
  __pyx_pybuffernd_CauchyStressTensor.diminfo[0].strides = __pyx_pybuffernd_CauchyStressTensor.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_CauchyStressTensor.diminfo[0].shape = __pyx_pybuffernd_CauchyStressTensor.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_CauchyStressTensor.diminfo[1].strides = __pyx_pybuffernd_CauchyStressTensor.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_CauchyStressTensor.diminfo[1].shape = __pyx_pybuffernd_CauchyStressTensor.rcbuffer->pybuffer.shape[1];

  /* "DisplacementApproachIndices.pyx":176
 * def GetTotalTraction(np.ndarray[double,ndim=2,mode='c'] CauchyStressTensor):
 *     cdef np.ndarray[double,ndim=2,mode='c'] TotalTraction
 *     cdef int ndim = CauchyStressTensor.shape[0]             # <<<<<<<<<<<<<<
 *     if ndim == 2:
 ...
 */
  ...
  /* "DisplacementApproachIndices.pyx":177
 *     cdef np.ndarray[double,ndim=2,mode='c'] TotalTraction
 *     cdef int ndim = CauchyStressTensor.shape[0]
 *     if ndim == 2:             # <<<<<<<<<<<<<<
 *         TotalTraction = np.zeros((3,1),dtype=np.float64)
 ...
 */
  switch (__pyx_v_ndim) {
    ...
    /* "DisplacementApproachIndices.pyx":178
 *     cdef int ndim = CauchyStressTensor.shape[0]
 *     if ndim == 2:
 *         TotalTraction = np.zeros((3,1),dtype=np.float64)             # <<<<<<<<<<<<<<
 *     elif ndim == 3:
 ...
 */
    ...
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 178, __pyx_L1_error)
    ...
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__2, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 178, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 */
    ...
    /* "DisplacementApproachIndices.pyx":180
 *         TotalTraction = np.zeros((3,1),dtype=np.float64)
 *     elif ndim == 3:
 *         TotalTraction = np.zeros((6,1),dtype=np.float64)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 180, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 180, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_tuple__4, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 180, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __pyx_t_5 = ((PyArrayObject *)__pyx_t_3);
    {
      ...
      __pyx_pybuffernd_TotalTraction.diminfo[0].strides = __pyx_pybuffernd_TotalTraction.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_TotalTraction.diminfo[0].shape = __pyx_pybuffernd_TotalTraction.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_TotalTraction.diminfo[1].strides = __pyx_pybuffernd_TotalTraction.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_TotalTraction.diminfo[1].shape = __pyx_pybuffernd_TotalTraction.rcbuffer->pybuffer.shape[1];
      if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 180, __pyx_L1_error)
    }
    __pyx_t_5 = 0;
    __pyx_v_TotalTraction = ((PyArrayObject *)__pyx_t_3);
    __pyx_t_3 = 0;

    /* "DisplacementApproachIndices.pyx":179
 *     if ndim == 2:
 *         TotalTraction = np.zeros((3,1),dtype=np.float64)
 *     elif ndim == 3:             # <<<<<<<<<<<<<<
 *         TotalTraction = np.zeros((6,1),dtype=np.float64)
 ...
 */
  ...
  /* "DisplacementApproachIndices.pyx":181
 *     elif ndim == 3:
 *         TotalTraction = np.zeros((6,1),dtype=np.float64)
 *     GetTotalTraction_(&TotalTraction[0,0], &CauchyStressTensor[0,0], ndim)             # <<<<<<<<<<<<<<
 *     return TotalTraction
 */
  ...
  __pyx_t_12 = 0;
  __pyx_t_13 = 0;
  __pyx_f_27DisplacementApproachIndices_GetTotalTraction_((&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_TotalTraction.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_TotalTraction.diminfo[0].strides, __pyx_t_11, __pyx_pybuffernd_TotalTraction.diminfo[1].strides))), (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_CauchyStressTensor.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_CauchyStressTensor.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_CauchyStressTensor.diminfo[1].strides))), __pyx_v_ndim);

  /* "DisplacementApproachIndices.pyx":182
 *         TotalTraction = np.zeros((6,1),dtype=np.float64)
 *     GetTotalTraction_(&TotalTraction[0,0], &CauchyStressTensor[0,0], ndim)
 *     return TotalTraction             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_TotalTraction.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("DisplacementApproachIndices.GetTotalTraction", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_CauchyStressTensor.rcbuffer->pybuffer);
...
static int __pyx_pymod_exec_DisplacementApproachIndices(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_DisplacementApproachIndices},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_DisplacementApproachIndices, __pyx_k_DisplacementApproachIndices, sizeof(__pyx_k_DisplacementApproachIndices), 0, 0, 1, 1},
  {&__pyx_kp_s_DisplacementApproachIndices_pyx, __pyx_k_DisplacementApproachIndices_pyx, sizeof(__pyx_k_DisplacementApproachIndices_pyx), 0, 0, 1, 0},
 ...
 *         TotalTraction = np.zeros((6,1),dtype=np.float64)
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_int_3, __pyx_int_1); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 178, __pyx_L1_error)
 ...
 *     return TotalTraction
 */
  __pyx_tuple__3 = PyTuple_Pack(2, __pyx_int_6, __pyx_int_1); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 180, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_tuple__3); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 180, __pyx_L1_error)
 ...
 *                      int ndim, int nvar):
 */
  __pyx_tuple__12 = PyTuple_Pack(6, __pyx_n_s_B, __pyx_n_s_SpatialGradient, __pyx_n_s_ndim, __pyx_n_s_nvar, __pyx_n_s_rows, __pyx_n_s_cols); if (unlikely(!__pyx_tuple__12)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__12);
  __Pyx_GIVEREF(__pyx_tuple__12);
  __pyx_codeobj__13 = (PyObject*)__Pyx_PyCode_New(4, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__12, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_DisplacementApproachIndices_pyx, __pyx_n_s_FillConstitutiveB, 45, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__13)) __PYX_ERR(0, 45, __pyx_L1_error)
 ...
 *                      np.ndarray[double,ndim=2,mode='c'] S,
 */
  __pyx_tuple__14 = PyTuple_Pack(8, __pyx_n_s_B, __pyx_n_s_SpatialGradient, __pyx_n_s_S, __pyx_n_s_CauchyStressTensor, __pyx_n_s_ndim, __pyx_n_s_nvar, __pyx_n_s_rows, __pyx_n_s_cols); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 138, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(6, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_DisplacementApproachIndices_pyx, __pyx_n_s_FillGeometricB, 138, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 138, __pyx_L1_error)
 ...
 *     cdef int ndim = CauchyStressTensor.shape[0]
 */
  __pyx_tuple__16 = PyTuple_Pack(3, __pyx_n_s_CauchyStressTensor, __pyx_n_s_TotalTraction, __pyx_n_s_ndim); if (unlikely(!__pyx_tuple__16)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__16);
  __Pyx_GIVEREF(__pyx_tuple__16);
  __pyx_codeobj__17 = (PyObject*)__Pyx_PyCode_New(1, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_DisplacementApproachIndices_pyx, __pyx_n_s_GetTotalTraction, 174, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__17)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initDisplacementApproachIndices(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initDisplacementApproachIndices(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_DisplacementApproachIndices(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_DisplacementApproachIndices(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_DisplacementApproachIndices(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'DisplacementApproachIndices' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_DisplacementApproachIndices(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("DisplacementApproachIndices", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_DisplacementApproachIndices) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "DisplacementApproachIndices")) {
      if (unlikely(PyDict_SetItemString(modules, "DisplacementApproachIndices", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "DisplacementApproachIndices.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * from cython cimport boundscheck, wraparound
 */
 ...
 *                      int ndim, int nvar):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_27DisplacementApproachIndices_1FillConstitutiveB, NULL, __pyx_n_s_DisplacementApproachIndices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_FillConstitutiveB, __pyx_t_1) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *                      np.ndarray[double,ndim=2,mode='c'] S,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_27DisplacementApproachIndices_3FillGeometricB, NULL, __pyx_n_s_DisplacementApproachIndices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 138, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_FillGeometricB, __pyx_t_1) < 0) __PYX_ERR(0, 138, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef int ndim = CauchyStressTensor.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_27DisplacementApproachIndices_5GetTotalTraction, NULL, __pyx_n_s_DisplacementApproachIndices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_GetTotalTraction, __pyx_t_1) < 0) __PYX_ERR(0, 174, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init DisplacementApproachIndices", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init DisplacementApproachIndices");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
