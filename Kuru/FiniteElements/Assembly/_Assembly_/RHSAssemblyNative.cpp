...
#define __PYX_HAVE__RHSAssemblyNative
#define __PYX_HAVE_API__RHSAssemblyNative
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 * 
 */
typedef __pyx_t_5numpy_int64_t __pyx_t_17RHSAssemblyNative_Int;

/* "RHSAssemblyNative.pyx":7
 * # ctypedef Int long long int
 * ctypedef np.int64_t Int
 * ctypedef np.float64_t Float             # <<<<<<<<<<<<<<
 * 
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_17RHSAssemblyNative_Float;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'RHSAssemblyNative' */
static CYTHON_INLINE void __pyx_f_17RHSAssemblyNative_RHSAssemblyNative_(__pyx_t_17RHSAssemblyNative_Float *, __pyx_t_17RHSAssemblyNative_Float const *, __pyx_t_17RHSAssemblyNative_Int, __pyx_t_17RHSAssemblyNative_Int, __pyx_t_17RHSAssemblyNative_Int, long, unsigned long const *); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_17RHSAssemblyNative_Float = { "Float", NULL, sizeof(__pyx_t_17RHSAssemblyNative_Float), { 0 }, 0, 'R', 0, 0 };
...
#define __Pyx_MODULE_NAME "RHSAssemblyNative"
extern int __pyx_module_is_main_RHSAssemblyNative;
int __pyx_module_is_main_RHSAssemblyNative = 0;

/* Implementation of 'RHSAssemblyNative' */
...
static const char __pyx_k_RHSAssemblyNative[] = "RHSAssemblyNative";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_RHSAssemblyNative_pyx[] = "RHSAssemblyNative.pyx";
...
static PyObject *__pyx_n_s_RHSAssemblyNative;
static PyObject *__pyx_kp_s_RHSAssemblyNative_pyx;
...
static PyObject *__pyx_pf_17RHSAssemblyNative_RHSAssemblyNative(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_T, PyArrayObject *__pyx_v_t, __pyx_t_17RHSAssemblyNative_Int __pyx_v_elem, __pyx_t_17RHSAssemblyNative_Int __pyx_v_nvar, __pyx_t_17RHSAssemblyNative_Int __pyx_v_nodeperelem, PyArrayObject *__pyx_v_elements); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_17RHSAssemblyNative_1RHSAssemblyNative(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_17RHSAssemblyNative_1RHSAssemblyNative = {"RHSAssemblyNative", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_17RHSAssemblyNative_1RHSAssemblyNative, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_17RHSAssemblyNative_1RHSAssemblyNative(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_T = 0;
  PyArrayObject *__pyx_v_t = 0;
  __pyx_t_17RHSAssemblyNative_Int __pyx_v_elem;
  __pyx_t_17RHSAssemblyNative_Int __pyx_v_nvar;
  __pyx_t_17RHSAssemblyNative_Int __pyx_v_nodeperelem;
  PyArrayObject *__pyx_v_elements = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("RHSAssemblyNative (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_T,&__pyx_n_s_t,&__pyx_n_s_elem,&__pyx_n_s_nvar,&__pyx_n_s_nodeperelem,&__pyx_n_s_elements,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_t)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("RHSAssemblyNative", 1, 6, 6, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_elem)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("RHSAssemblyNative", 1, 6, 6, 2); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nvar)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("RHSAssemblyNative", 1, 6, 6, 3); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nodeperelem)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("RHSAssemblyNative", 1, 6, 6, 4); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_elements)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("RHSAssemblyNative", 1, 6, 6, 5); __PYX_ERR(0, 19, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "RHSAssemblyNative") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
    ...
    __pyx_v_elem = __Pyx_PyInt_As_npy_int64(values[2]); if (unlikely((__pyx_v_elem == ((npy_int64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_nvar = __Pyx_PyInt_As_npy_int64(values[3]); if (unlikely((__pyx_v_nvar == ((npy_int64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_nodeperelem = __Pyx_PyInt_As_npy_int64(values[4]); if (unlikely((__pyx_v_nodeperelem == ((npy_int64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_elements = ((PyArrayObject *)values[5]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("RHSAssemblyNative", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("RHSAssemblyNative.RHSAssemblyNative", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_t), __pyx_ptype_5numpy_ndarray, 1, "t", 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_elements), __pyx_ptype_5numpy_ndarray, 1, "elements", 0))) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_r = __pyx_pf_17RHSAssemblyNative_RHSAssemblyNative(__pyx_self, __pyx_v_T, __pyx_v_t, __pyx_v_elem, __pyx_v_nvar, __pyx_v_nodeperelem, __pyx_v_elements);
...
static PyObject *__pyx_pf_17RHSAssemblyNative_RHSAssemblyNative(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_T, PyArrayObject *__pyx_v_t, __pyx_t_17RHSAssemblyNative_Int __pyx_v_elem, __pyx_t_17RHSAssemblyNative_Int __pyx_v_nvar, __pyx_t_17RHSAssemblyNative_Int __pyx_v_nodeperelem, PyArrayObject *__pyx_v_elements) {
  ...
  __Pyx_RefNannySetupContext("RHSAssemblyNative", 0);
  ...
  __pyx_pybuffernd_elements.rcbuffer = &__pyx_pybuffer_elements;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_T.rcbuffer->pybuffer, (PyObject*)__pyx_v_T, &__Pyx_TypeInfo_nn___pyx_t_17RHSAssemblyNative_Float, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_elements.rcbuffer->pybuffer, (PyObject*)__pyx_v_elements, &__Pyx_TypeInfo_unsigned_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
 ...
 */
  __pyx_v_nelem = (__pyx_v_elements->dimensions[0]);

  /* "RHSAssemblyNative.pyx":25
 *     cdef long nelem = elements.shape[0]
 * 
 *     RHSAssemblyNative_(&T[0,0],&t[0,0],elem,nvar,nodeperelem,nelem,&elements[0,0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_5 = 0;
  __pyx_t_6 = 0;
  __pyx_f_17RHSAssemblyNative_RHSAssemblyNative_((&(*__Pyx_BufPtrStrided2d(__pyx_t_17RHSAssemblyNative_Float *, __pyx_pybuffernd_T.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_T.diminfo[0].strides, __pyx_t_2, __pyx_pybuffernd_T.diminfo[1].strides))), (&(*__Pyx_BufPtrStrided2d(__pyx_t_17RHSAssemblyNative_Float *, __pyx_pybuffernd_t.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_t.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_t.diminfo[1].strides))), __pyx_v_elem, __pyx_v_nvar, __pyx_v_nodeperelem, __pyx_v_nelem, (&(*__Pyx_BufPtrCContig2d(unsigned long *, __pyx_pybuffernd_elements.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_elements.diminfo[0].strides, __pyx_t_6, __pyx_pybuffernd_elements.diminfo[1].strides))));
...
static CYTHON_INLINE void __pyx_f_17RHSAssemblyNative_RHSAssemblyNative_(__pyx_t_17RHSAssemblyNative_Float *__pyx_v_T, __pyx_t_17RHSAssemblyNative_Float const *__pyx_v_t, __pyx_t_17RHSAssemblyNative_Int __pyx_v_elem, __pyx_t_17RHSAssemblyNative_Int __pyx_v_nvar, __pyx_t_17RHSAssemblyNative_Int __pyx_v_nodeperelem, CYTHON_UNUSED long __pyx_v_nelem, unsigned long const *__pyx_v_elements) {
  __pyx_t_17RHSAssemblyNative_Int __pyx_v_i;
  __pyx_t_17RHSAssemblyNative_Int __pyx_v_T_idx;
  __pyx_t_17RHSAssemblyNative_Int __pyx_v_iterator;
  __Pyx_RefNannyDeclarations
  __pyx_t_17RHSAssemblyNative_Int __pyx_t_1;
  __pyx_t_17RHSAssemblyNative_Int __pyx_t_2;
  __pyx_t_17RHSAssemblyNative_Int __pyx_t_3;
  __pyx_t_17RHSAssemblyNative_Int __pyx_t_4;
  __pyx_t_17RHSAssemblyNative_Int __pyx_t_5;
  __pyx_t_17RHSAssemblyNative_Int __pyx_t_6;
  __pyx_t_17RHSAssemblyNative_Int __pyx_t_7;
  __Pyx_RefNannySetupContext("RHSAssemblyNative_", 0);

  /* "RHSAssemblyNative.pyx":36
 * 
 ...
 */
    __pyx_v_T_idx = ((__pyx_v_elements[((__pyx_v_elem * __pyx_v_nodeperelem) + __pyx_v_i)]) * __pyx_v_nvar);

    /* "RHSAssemblyNative.pyx":38
 *     for i in range(nodeperelem):
 *         T_idx = elements[elem*nodeperelem+i]*nvar
 *         for iterator in range(nvar):             # <<<<<<<<<<<<<<
 *             T[T_idx+iterator] += t[i*nvar+iterator]
 ...
 */
      __pyx_t_7 = (__pyx_v_T_idx + __pyx_v_iterator);
      (__pyx_v_T[__pyx_t_7]) = ((__pyx_v_T[__pyx_t_7]) + (__pyx_v_t[((__pyx_v_i * __pyx_v_nvar) + __pyx_v_iterator)]));
    }
  }
...
static int __pyx_pymod_exec_RHSAssemblyNative(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_RHSAssemblyNative},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_RHSAssemblyNative, __pyx_k_RHSAssemblyNative, sizeof(__pyx_k_RHSAssemblyNative), 0, 0, 1, 1},
  {&__pyx_kp_s_RHSAssemblyNative_pyx, __pyx_k_RHSAssemblyNative_pyx, sizeof(__pyx_k_RHSAssemblyNative_pyx), 0, 0, 1, 0},
 ...
 *     np.ndarray[unsigned long,ndim=2, mode='c'] elements):
 */
  __pyx_tuple__8 = PyTuple_Pack(7, __pyx_n_s_T, __pyx_n_s_t, __pyx_n_s_elem, __pyx_n_s_nvar, __pyx_n_s_nodeperelem, __pyx_n_s_elements, __pyx_n_s_nelem); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(6, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_RHSAssemblyNative_pyx, __pyx_n_s_RHSAssemblyNative, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initRHSAssemblyNative(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initRHSAssemblyNative(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_RHSAssemblyNative(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_RHSAssemblyNative(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_RHSAssemblyNative(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'RHSAssemblyNative' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_RHSAssemblyNative(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("RHSAssemblyNative", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_RHSAssemblyNative) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "RHSAssemblyNative")) {
      if (unlikely(PyDict_SetItemString(modules, "RHSAssemblyNative", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     np.ndarray[unsigned long,ndim=2, mode='c'] elements):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_17RHSAssemblyNative_1RHSAssemblyNative, NULL, __pyx_n_s_RHSAssemblyNative); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_RHSAssemblyNative, __pyx_t_1) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "RHSAssemblyNative.pyx":1
 * from cython cimport boundscheck, wraparound             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init RHSAssemblyNative", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init RHSAssemblyNative");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
