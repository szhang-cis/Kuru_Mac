...
static PyObject *__pyx_pf_4Kuru_15MaterialLibrary_10LLDispatch_12CythonSource_35_IncompressibleArterialWallMixture__KineticMeasures(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_material, PyArrayObject *__pyx_v_F, PyArrayObject *__pyx_v_anisotropic_orientations, PyArrayObject *__pyx_v_state_variables); /* proto */
...
static PyMethodDef __pyx_mdef_4Kuru_15MaterialLibrary_10LLDispatch_12CythonSource_35_IncompressibleArterialWallMixture__1KineticMeasures = {"KineticMeasures", (PyCFunction)__pyx_pw_4Kuru_15MaterialLibrary_10LLDispatch_12CythonSource_35_IncompressibleArterialWallMixture__1KineticMeasures, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4Kuru_15MaterialLibrary_10LLDispatch_12CythonSource_35_IncompressibleArterialWallMixture__1KineticMeasures(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_4Kuru_15MaterialLibrary_10LLDispatch_12CythonSource_35_IncompressibleArterialWallMixture__KineticMeasures(__pyx_self, __pyx_v_material, __pyx_v_F, __pyx_v_anisotropic_orientations, __pyx_v_state_variables);
...
static PyObject *__pyx_pf_4Kuru_15MaterialLibrary_10LLDispatch_12CythonSource_35_IncompressibleArterialWallMixture__KineticMeasures(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_material, PyArrayObject *__pyx_v_F, PyArrayObject *__pyx_v_anisotropic_orientations, PyArrayObject *__pyx_v_state_variables) {
  int __pyx_v_ndim;
  int __pyx_v_ngauss;
  int __pyx_v_nfibre;
  int __pyx_v_nstatv;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_state_variables.rcbuffer->pybuffer, (PyObject*)__pyx_v_state_variables, &__Pyx_TypeInfo_nn___pyx_t_4Kuru_15MaterialLibrary_10LLDispatch_12CythonSource_35_IncompressibleArterialWallMixture__Real, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 23, __pyx_L1_error)
  }
 ...
 *         np.ndarray[Real,ndim=2,mode='c'] state_variables):
 */
  __pyx_tuple__10 = PyTuple_Pack(12, __pyx_n_s_material, __pyx_n_s_F, __pyx_n_s_anisotropic_orientations, __pyx_n_s_state_variables, __pyx_n_s_ndim, __pyx_n_s_ngauss, __pyx_n_s_nfibre, __pyx_n_s_nstatv, __pyx_n_s_stress, __pyx_n_s_hessian, __pyx_n_s_pressure, __pyx_n_s_mat_obj); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(4, 0, 12, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_CythonSource__IncompressibleArte, __pyx_n_s_KineticMeasures, 23, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_IncompressibleArterialWallMixture_(void); /*proto*/
PyMODINIT_FUNC init_IncompressibleArterialWallMixture_(void)
#else
PyMODINIT_FUNC PyInit__IncompressibleArterialWallMixture_(void); /*proto*/
PyMODINIT_FUNC PyInit__IncompressibleArterialWallMixture_(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__IncompressibleArterialWallMixture_(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Kuru.MaterialLibrary.LLDispatch.CythonSource._IncompressibleArterialWallMixture_", 0, __pyx_lineno, __pyx_filename);
    }
