#ifndef _LLADF__INCOMPRESSIBLENEOHOOKEAN_H
#define _LLADF__INCOMPRESSIBLENEOHOOKEAN_H

#include "assembly_helper.h"
#include "_ConstitutiveStiffnessDF_.h"
#include "_VolumetricStiffness_.h"
#include "_IncompressibleNeoHookean_.h"

void _GlobalAssemblyDF__IncompressibleNeoHookean_(const Real *points,
    ...
    auto mat_obj = _IncompressibleNeoHookean_<Real>(mu);
    ...
    for (Integer elem=0; elem < nelem; ++elem) {
        ...
        mat_obj.KineticMeasures(stress, hessian, ndim, ngauss, F, pressure[0]);
