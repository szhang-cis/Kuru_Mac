      SUBROUTINE SHAP11T(CARDDT,DVOLDT,ELCODT,GPCDDT,LNODST,PROPST,
...
C
      posgpt(1,1)=1.0D0/4.0D0
      posgpt(2,1)=1.0D0/4.0D0
      posgpt(3,1)=1.0D0/4.0D0
      posgpt(1,2)=0.0D0
      posgpt(2,2)=0.0D0
      posgpt(3,2)=0.0D0
      posgpt(1,3)=0.0D0
...
C
      RDISCT=1.0D0*frrrc+exisp*frrr1+etasp*frrr2+ezeta*frrr3
      SDISCT=1.0D0*fsssc+exisp*fsss1+etasp*fsss2+ezeta*fsss3
      TDISCT=1.0D0*ftttc+exisp*fttt1+etasp*fttt2+ezeta*fttt3
C
