      SUBROUTINE FUNLO4(FACTI,HTLOD,TTIME)
C***********************************************************************
C
C****THIS ROUTINE MODELS A SAW_TOOTH SIGNAL
C
C***********************************************************************
...
C
      IF(TAUTI.GT.PERI1.AND.TAUTI.LT.PERI2)
     .  FACTI=HTLOD(5)*(1.-2.*(TAUTI-PERI1)/PERI3)
C
      IF(TAUTI.GE.PERI2) 
     .  FACTI=HTLOD(5)*(((TAUTI-PERI2)/(PERI0-PERI2)-1.))
C      
      RETURN
      END
