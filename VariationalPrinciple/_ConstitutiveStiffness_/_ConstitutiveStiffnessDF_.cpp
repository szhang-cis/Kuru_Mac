...
static PyMethodDef __pyx_mdef_25_ConstitutiveStiffnessDF__1__ConstitutiveStiffnessIntegrandDF__ = {"__ConstitutiveStiffnessIntegrandDF__", (PyCFunction)__pyx_pw_25_ConstitutiveStiffnessDF__1__ConstitutiveStiffnessIntegrandDF__, METH_VARARGS|METH_KEYWORDS, 0};
  ...
  __Pyx_RefNannySetupContext("__ConstitutiveStiffnessIntegrandDF__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_CauchyStressTensor)) != 0)) kw_args--;
        else {
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(6, 0, 13, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ConstitutiveStiffnessDF__pyx, __pyx_n_s_ConstitutiveStiffnessIntegrand, 27, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_ConstitutiveStiffnessDF_(void); /*proto*/
PyMODINIT_FUNC init_ConstitutiveStiffnessDF_(void)
#else
PyMODINIT_FUNC PyInit__ConstitutiveStiffnessDF_(void); /*proto*/
PyMODINIT_FUNC PyInit__ConstitutiveStiffnessDF_(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__ConstitutiveStiffnessDF_(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _ConstitutiveStiffnessDF_", 0, __pyx_lineno, __pyx_filename);
    }
