...
static PyMethodDef __pyx_mdef_19_KinematicMeasures__1_KinematicMeasures_ = {"_KinematicMeasures_", (PyCFunction)__pyx_pw_19_KinematicMeasures__1_KinematicMeasures_, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_19_KinematicMeasures__1_KinematicMeasures_(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_KinematicMeasures_ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Jm)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_AllGauss)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_KinematicMeasures_", 1, 5, 5, 1); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_LagrangeElemCoords)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_KinematicMeasures_", 1, 5, 5, 2); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_EulerElemCoords)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_KinematicMeasures_", 1, 5, 5, 3); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_requires_geometry_update)) != 0)) kw_args--;
        else {
 ...
 *     np.ndarray[Real, ndim=2, mode='c'] LagrangeElemCoords,
 */
  __pyx_tuple__10 = PyTuple_Pack(13, __pyx_n_s_Jm, __pyx_n_s_AllGauss, __pyx_n_s_LagrangeElemCoords, __pyx_n_s_EulerElemCoords, __pyx_n_s_requires_geometry_update, __pyx_n_s_ndim, __pyx_n_s_nodeperelem, __pyx_n_s_ngauss, __pyx_n_s_update, __pyx_n_s_F, __pyx_n_s_SpatialGradient, __pyx_n_s_detJ, __pyx_n_s_dV); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(5, 0, 13, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_KinematicMeasures__pyx, __pyx_n_s_KinematicMeasures, 20, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_KinematicMeasures_(void); /*proto*/
PyMODINIT_FUNC init_KinematicMeasures_(void)
#else
PyMODINIT_FUNC PyInit__KinematicMeasures_(void); /*proto*/
PyMODINIT_FUNC PyInit__KinematicMeasures_(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__KinematicMeasures_(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _KinematicMeasures_", 0, __pyx_lineno, __pyx_filename);
    }
