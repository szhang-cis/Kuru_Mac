      SUBROUTINE FROELIS(DISIT,ELOAD,EQRHS,EQUAT,GLOAD,GSTIF,IDSK2,
...
C
       ...
       ELSE                   ! kresl.ne.1
        ...
        call runends('kresl=1 in froelis')
...
C
        IF(KPORE.NE.2.OR.IMODU.NE.0.OR.PIVOT.EQ.0.) THEN
         WRITE(LURESS,900) NIKNO,PIVOT
         CALL RUNMENS('NEGATIVE PIVOT IN FRONT            ')
        ENDIF
C
       ENDIF
C
