...
static PyMethodDef __pyx_mdef_17RHSAssemblyNative_1RHSAssemblyNative = {"RHSAssemblyNative", (PyCFunction)__pyx_pw_17RHSAssemblyNative_1RHSAssemblyNative, METH_VARARGS|METH_KEYWORDS, 0};
  ...
  __Pyx_RefNannySetupContext("RHSAssemblyNative (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_elem)) != 0)) kw_args--;
        else {
        ...
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nodeperelem)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("RHSAssemblyNative", 1, 6, 6, 4); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_elements)) != 0)) kw_args--;
        else {
 ...
 */
      __pyx_t_5 = (__pyx_v_T_idx + __pyx_v_iterator);
      (__pyx_v_T[__pyx_t_5]) = ((__pyx_v_T[__pyx_t_5]) + (__pyx_v_t[((__pyx_v_i * __pyx_v_nvar) + __pyx_v_iterator)]));
    }
  }
 ...
 *     np.ndarray[unsigned long,ndim=2, mode='c'] elements):
 */
  __pyx_tuple__10 = PyTuple_Pack(7, __pyx_n_s_T, __pyx_n_s_t, __pyx_n_s_elem, __pyx_n_s_nvar, __pyx_n_s_nodeperelem, __pyx_n_s_elements, __pyx_n_s_nelem); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(6, 0, 7, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_RHSAssemblyNative_pyx, __pyx_n_s_RHSAssemblyNative, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initRHSAssemblyNative(void); /*proto*/
PyMODINIT_FUNC initRHSAssemblyNative(void)
#else
PyMODINIT_FUNC PyInit_RHSAssemblyNative(void); /*proto*/
PyMODINIT_FUNC PyInit_RHSAssemblyNative(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_RHSAssemblyNative(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init RHSAssemblyNative", 0, __pyx_lineno, __pyx_filename);
    }
