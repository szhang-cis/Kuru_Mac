C=======================================================================
      subroutine gmress(CSTIF,NEQNS,BGMRE,XGMRE,WGMRE,
...
C     NEQNS,NLAST,LNUEQ,LPONT (as in skygra.f)
C
C     Note: NLAST & LPONT are not needed but they are read here because
C           skydes.f was used in soladd.f
C
      REWIND IDSK2
      READ(IDSK2) NEQNS,NLAST,LNUEQ,LPONT
C-----------------------------------------------------------------------
C
      call gmresp(CSTIF,DIAGO,NEQNS,WGMRE,XGMRE,MKRYL,MITGM,
