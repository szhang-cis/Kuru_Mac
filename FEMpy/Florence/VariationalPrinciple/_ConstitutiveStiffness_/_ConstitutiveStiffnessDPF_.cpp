...
static PyMethodDef __pyx_mdef_26_ConstitutiveStiffnessDPF__1__ConstitutiveStiffnessIntegrandDPF__ = {"__ConstitutiveStiffnessIntegrandDPF__", (PyCFunction)__pyx_pw_26_ConstitutiveStiffnessDPF__1__ConstitutiveStiffnessIntegrandDPF__, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_26_ConstitutiveStiffnessDPF__1__ConstitutiveStiffnessIntegrandDPF__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__ConstitutiveStiffnessIntegrandDPF__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_SpatialGradient)) != 0)) kw_args--;
        ...
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_CauchyStressTensor)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__ConstitutiveStiffnessIntegrandDPF__", 1, 7, 7, 2); __PYX_ERR(0, 28, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_H_Voigt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__ConstitutiveStiffnessIntegrandDPF__", 1, 7, 7, 3); __PYX_ERR(0, 28, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_detJ)) != 0)) kw_args--;
        else {
        ...
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_requires_geometry_update)) != 0)) kw_args--;
        else {
 ...
 *     np.ndarray[Real, ndim=3, mode='c'] CauchyStressTensor,
 */
  __pyx_tuple__10 = PyTuple_Pack(14, __pyx_n_s_SpatialGradient, __pyx_n_s_ElectricDisplacementx, __pyx_n_s_CauchyStressTensor, __pyx_n_s_H_Voigt, __pyx_n_s_detJ, __pyx_n_s_nvar, __pyx_n_s_requires_geometry_update, __pyx_n_s_ngauss, __pyx_n_s_nodeperelem, __pyx_n_s_ndim, __pyx_n_s_local_size, __pyx_n_s_H_VoigtSize, __pyx_n_s_traction, __pyx_n_s_stiffness); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(7, 0, 14, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ConstitutiveStiffnessDPF__pyx, __pyx_n_s_ConstitutiveStiffnessIntegrand, 28, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_ConstitutiveStiffnessDPF_(void); /*proto*/
PyMODINIT_FUNC init_ConstitutiveStiffnessDPF_(void)
#else
PyMODINIT_FUNC PyInit__ConstitutiveStiffnessDPF_(void); /*proto*/
PyMODINIT_FUNC PyInit__ConstitutiveStiffnessDPF_(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__ConstitutiveStiffnessDPF_(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _ConstitutiveStiffnessDPF_", 0, __pyx_lineno, __pyx_filename);
    }
