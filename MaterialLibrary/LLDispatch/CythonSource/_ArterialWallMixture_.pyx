...
cdef extern from "_ArterialWallMixture_.h" nogil:
    cdef cppclass _ArterialWallMixture_[Real]:
        ...
        _ArterialWallMixture_(Real mu,Real kappa,Real k1m,Real k2m,Real k1c,Real k2c,Real rho,
            Real s_act,Real stretch_m,Real stretch_0,Real stretch_a,Real pressure,Real f_incr) except +
        ...
        void KineticMeasures(Real *Snp, Real* Hnp, int ndim, int ngauss, const Real *Fnp, 
            int nfibre, const Real *Nnp, int nstatv, const Real *SVnp, int near_incomp) except +
...
def KineticMeasures(material, np.ndarray[Real,ndim=3,mode='c'] F,
    ...
    mat_obj.SetParameters(material.mu,material.kappa,material.k1m,material.k2m,material.k1c,
        ...
        material.zero_active_stretch,material.active_stretch,material.pressure,material.factor_increment)
...
cdef ConstituentMeasures_(Real *stress, Real *softness, Real *Fnp, Real *SVnp, Real *Nnp,
        Real rho, Real k1m, Real k2m, Real k1c, Real k2c, Real s_act, Real stretch_m, Real stretch_0, Real stretch_a,
