...
static PyMethodDef __pyx_methods[] = {
  ...
  {"dgemm", (PyCFunction)__pyx_pw_4Kuru_6Tensor_6LinAlg_9dgemm, METH_VARARGS|METH_KEYWORDS, 0},
  {"daxpy", (PyCFunction)__pyx_pw_4Kuru_6Tensor_6LinAlg_11daxpy, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Kuru.Tensor.LinAlg", 0, __pyx_lineno, __pyx_filename);
    }
