      SUBROUTINE SHAP07T(CARDDT,DVOLDT,ELCODT,GPCDDT,LNODST,PROPST,
...
C
      posgpt(1,1)=1.0D0/3.0D0
      posgpt(2,1)=1.0D0/3.0D0
      posgpt(1,2)=0.0D0
      posgpt(2,2)=0.0D0
      posgpt(1,3)=0.0D0
      posgpt(2,3)=0.0D0
c
      weigpt(1)=1.0D0/2.0D0
      weigpt(2)=0.0D0
      weigpt(3)=0.0D0
C
...
C
      RDISCT=1.0D0*frrrc+exisp*frrr1+etasp*frrr2
      SDISCT=1.0D0*fsssc+exisp*fsss1+etasp*fsss2
      TDISCT=0.0D0
C
