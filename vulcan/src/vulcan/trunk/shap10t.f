      SUBROUTINE SHAP10T(CARDDT,DVOLDT,ELCODT,GPCDDT,LNODST,PROPST,
...
C     IN A BIPHASE/MULTIPHASE UNIDIMENSIONAL ELEMENT FOR THE CASE:
C
...
C
      NRULEA=3                         ! nrulea=3 or 5 (better as input)
      CALL RULEPW(NDIMET,NGAULT,NRULEA,POSGPT,WEIGPT)
C
