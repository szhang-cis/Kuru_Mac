      SUBROUTINE FR2D01T(PROPST,VELCMT,ELELMT,DVOLUT,SHAPET,EHISTT,
...
C     PHASE-CHANGE WHEN IT HAS TWO PHASES ONLY FOR 2D ELEMENTS (4-NODED)
C
...
C
      ...
      ELSE
       ...
       ELDI4=ELDIST(1,4)
      ENDIF
      CALL COIN01T(ELDI4,ELDI1,TEMPLT,SCOOR,ISOLI)
