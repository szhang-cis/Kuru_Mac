...
static PyMethodDef __pyx_mdef_20_GeometricStiffness__1GeometricStiffnessIntegrand = {"GeometricStiffnessIntegrand", (PyCFunction)__pyx_pw_20_GeometricStiffness__1GeometricStiffnessIntegrand, METH_VARARGS|METH_KEYWORDS, 0};
  ...
  __Pyx_RefNannySetupContext("GeometricStiffnessIntegrand (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_detJ)) != 0)) kw_args--;
        else {
 ...
 *     np.ndarray[Real, ndim=1] detJ, int nvar):
 */
  __pyx_tuple__10 = PyTuple_Pack(9, __pyx_n_s_SpatialGradient, __pyx_n_s_CauchyStressTensor, __pyx_n_s_detJ, __pyx_n_s_nvar, __pyx_n_s_ngauss, __pyx_n_s_nodeperelem, __pyx_n_s_ndim, __pyx_n_s_local_size, __pyx_n_s_geometric_stiffness); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(4, 0, 9, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_GeometricStiffness__pyx, __pyx_n_s_GeometricStiffnessIntegrand, 18, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_GeometricStiffness_(void); /*proto*/
PyMODINIT_FUNC init_GeometricStiffness_(void)
#else
PyMODINIT_FUNC PyInit__GeometricStiffness_(void); /*proto*/
PyMODINIT_FUNC PyInit__GeometricStiffness_(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__GeometricStiffness_(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _GeometricStiffness_", 0, __pyx_lineno, __pyx_filename);
    }
