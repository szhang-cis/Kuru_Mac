  ...
  __Pyx_RefNannySetupContext("KineticMeasures (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_field_variables)) != 0)) kw_args--;
        else {
 ...
 *         np.ndarray[Real,ndim=2,mode='c'] field_variables):
 */
  __pyx_tuple__10 = PyTuple_Pack(11, __pyx_n_s_material, __pyx_n_s_F, __pyx_n_s_anisotropic_orientations, __pyx_n_s_field_variables, __pyx_n_s_ndim, __pyx_n_s_ngauss, __pyx_n_s_nfibre, __pyx_n_s_nfield, __pyx_n_s_stress, __pyx_n_s_hessian, __pyx_n_s_mat_obj); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 23, __pyx_L1_error)
