...
from Kuru.Tensor import itemfreq, makezero, unique2d, remove_duplicates_2D
...
def HighOrderMeshHex(C, mesh, Decimals=10, equally_spaced=False, check_duplicates=True,
    ...
    from Kuru.FunctionSpace import Hex, HexES
    from Kuru.QuadratureRules import GaussLobattoPointsHex
    from Kuru.QuadratureRules.EquallySpacedPoints import EquallySpacedPoints
    from Kuru.MeshGeneration.NodeArrangement import NodeArrangementHex
