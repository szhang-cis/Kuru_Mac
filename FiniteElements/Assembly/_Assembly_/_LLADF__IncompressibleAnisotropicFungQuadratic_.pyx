...
cdef extern from "_LLADF__IncompressibleAnisotropicFungQuadratic_.h" nogil:
...
def _LLADF__IncompressibleAnisotropicFungQuadratic_(fem_solver, function_space, formulation, mesh, material, Real[:,::1] Eulerx):
    ...
    _GlobalAssemblyDF__IncompressibleAnisotropicFungQuadratic_(     &points[0,0],
                            &elements[0,0],
                            &Eulerx[0,0],
                            &Bases[0,0],
                            &Jm[0,0,0],
