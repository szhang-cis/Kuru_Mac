...
static PyMethodDef __pyx_mdef_32_ConstitutiveStiffnessLaplacian__1__ConstitutiveStiffnessIntegrandLaplacian__ = {"__ConstitutiveStiffnessIntegrandLaplacian__", (PyCFunction)__pyx_pw_32_ConstitutiveStiffnessLaplacian__1__ConstitutiveStiffnessIntegrandLaplacian__, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 *     np.ndarray[Real, ndim=3, mode='c'] H_Voigt,
 */
  __pyx_tuple__10 = PyTuple_Pack(13, __pyx_n_s_SpatialGradient, __pyx_n_s_ElectricDisplacementx, __pyx_n_s_H_Voigt, __pyx_n_s_detJ, __pyx_n_s_nvar, __pyx_n_s_requires_geometry_update, __pyx_n_s_ngauss, __pyx_n_s_nodeperelem, __pyx_n_s_ndim, __pyx_n_s_local_size, __pyx_n_s_H_VoigtSize, __pyx_n_s_traction, __pyx_n_s_stiffness); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(6, 0, 13, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ConstitutiveStiffnessLaplacian, __pyx_n_s_ConstitutiveStiffnessIntegrand, 27, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_ConstitutiveStiffnessLaplacian_(void); /*proto*/
PyMODINIT_FUNC init_ConstitutiveStiffnessLaplacian_(void)
#else
PyMODINIT_FUNC PyInit__ConstitutiveStiffnessLaplacian_(void); /*proto*/
PyMODINIT_FUNC PyInit__ConstitutiveStiffnessLaplacian_(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__ConstitutiveStiffnessLaplacian_(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _ConstitutiveStiffnessLaplacian_", 0, __pyx_lineno, __pyx_filename);
    }
