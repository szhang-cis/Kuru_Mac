...
class IncompressibleArterialWallMixture(Material):
    ...
    def KineticMeasures(self,F, elem=0):
        ...
        # Field variables are filled first with deposition_stretch then with densities, 
        # remodeling and growth, deposition (0-8 is elastin, 9 muscle, 10-13 collagen) 
        # then densities (14-19) and growth (20)
