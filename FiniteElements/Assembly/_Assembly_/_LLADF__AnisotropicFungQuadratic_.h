...
#include "_AnisotropicFungQuadratic_.h"
...
void _GlobalAssemblyDF__AnisotropicFungQuadratic_(const Real *points,
    ...
    auto mat_obj = _AnisotropicFungQuadratic_<Real>(mu,kappa,k1,k2);
    ...
    for (Integer elem=0; elem < nelem; ++elem) {
        ...
        mat_obj.KineticMeasures(stress, hessian, ndim, ngauss, F, nfibre, &anisotropic_orientations[elem*nfibre*ndim]);
