      SUBROUTINE COUSTA6(LNODS,MATNO,PROEL,PROPS,COORD,HTLOD,
...
C
c       IF(IPRCOT.EQ.0)
c    .   CALL OUTPUTT(DISTOT,ELDATT,ELPRET,ELVART,ELMATT,HEADST,
...
C
        GO TO 100
       ENDIF  ! thermal problem is converged => global converg.
      ENDIF   ! mechanical problem is converged => global convergence
C
