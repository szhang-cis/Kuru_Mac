      SUBROUTINE MAMF3DT(DVOLUT,PROPST,SHAPET,WSTIFT,EHISTT,SHAPDT,
...
C
     ...
     .          SHAPET(NNODLT,*), DVOLDT(*),
     .          POSGPT(NDIMET,*), SHAPDT(NNODLT,*)
...
C
         CALL LAHE11T(POSGPT,SHAPDT,DVOLDT,PROPST,EHISTT,ELDIST,SHAPET,
...
C
     ...
     .             FR123*FSS13*FTT23 + FR123*FSS23*FTT13
          ...
          CALL LAHE08T(POSGPT,SHAPDT,DVOLDT,PROPST,EHISTT,ELDIST,SHAPET,
     .                 WSTIFT,VELCMT,WSTI1T,WSTI2T,
