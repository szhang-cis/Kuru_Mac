      SUBROUTINE SHAP12T(CARDDT,DVOLDT,ELCODT,GPCDDT,LNODST,PROPST,
...
C     IN A BIPHASE/MULTIPHASE TRIDIMENSIONAL ELEMENT FOR THE CASE:
C
...
C
      ...
      POSGPT(3,4)= A
C
      WEIGPT(1)  = 1.D+00/24.D+00
      WEIGPT(2)  = 1.D+00/24.D+00
      WEIGPT(3)  = 1.D+00/24.D+00
      WEIGPT(4)  = 1.D+00/24.D+00
C
...
C
      RDISCT=1.0*frrrc+exisp*frrr1+etasp*frrr2+ezeta*frrr3
      SDISCT=1.0*fsssc+exisp*fsss1+etasp*fsss2+ezeta*fsss3
      TDISCT=1.0*ftttc+exisp*fttt1+etasp*fttt2+ezeta*fttt3
C
