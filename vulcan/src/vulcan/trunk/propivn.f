      SUBROUTINE PROPIVN(ITAPE,PROPS)
C***********************************************************************
C
...
C
      ...
      PROPS(3)=1.0D0           ! no temperature-dependent
...
C
      CALL LISTEN('PROPIVN',NPRIN,ITAPE)
      ...
      ELSE
       IF(KDYNA.EQ.1) THEN
        CALL RUNEND('PROPIVN: DENSITY CARD NOT FOUND')
       ELSE
        PROPS(12)=0.0D0
...
C
    ...
    1 IF(WORDS(1).EQ.'YOUNG') THEN
       ...
       WRITE(LURES,899)
      ELSE
       CALL RUNEND('PROPIVN: YOUNG_MODULUS CARD NOT FOUND')
      ENDIF
C
...
C
      ...
      IF(WORDS(1).EQ.'POISS') THEN
       ...
       WRITE(LURES,899)
      ELSE
       CALL RUNEND('PROPIVN: POISSON_RATIO CARD NOT FOUND')
      ENDIF
C
...
C
    ...
    2 IF(WORDS(1).EQ.'THERM') THEN
       IF(NTEMP.EQ.1)
     .  CALL RUNEND('PROPIVN: REFERENCE TEMPERATURE CARD NOT FOUND')
       NPOI1=NPOI2+1
       NPOI2=NPOI1
       PROPS(NPOI1)=PARAM(1)
...
C
    ...
    3 IF((WORDS(1).EQ.'HD_FU').OR.(WORDS(1).EQ.'TH_HD')) THEN
       ...
       WRITE(LURES,899)
      ELSE
       CALL RUNEND('PROPIVN: HARDEN. FUNCTION CARD NOT FOUND')
      ENDIF
C
...
C
      ...
      IF(WORDS(1).EQ.'FLOW_') THEN
       ...
       ENDIF
      ELSE
       CALL RUNEND('PROPIVN: FLOW_PARAMETERS CARD NOT FOUND')
      ENDIF
C
...
C
      IF(IVIFL.EQ.1.OR.IVIFL.EQ.2.OR.IVIFL.EQ.3) THEN
       ...
       IF(WORDS(1).EQ.'VISCO') THEN
        ...
        WRITE(LURES,899)
       ELSE
        CALL RUNEND('PROPIVN: VISCOSITY CARD NOT FOUND')
       ENDIF
      ENDIF           ! ivifl.eq.1.or.ivifl.eq.2.or.ivifl.eq.3
C
C**** LOOK FOR ZABARAS' COEFFICIENTS (A, B & C)
C
c     IF(IVIFL.EQ.4) THEN    ! not implemented
C
C**** COEFFICIENT A
C
c      NPRIN=0
c      CALL LISTEN('PROPIVT',NPRIN,ITAPE)
c      IF(WORDS(1).EQ.'A_COE') THEN
c       NPOI1=NPOI2+1
c       NPOI2=NPOI1
c       PROPS(NPOI1)=PARAM(1)
c       NLINE=INT(PARAM(1))
c       IF(NLINE.GT.20)
c    .   CALL RUNEND('ERROR: WRONG NUMBER OF POINTS IN A_COEF')
c       NPRIN=1
c       DO LINEA=1,NLINE
c        CALL LISTEN('PROPIVT',NPRIN,ITAPE)
c        DO I=1,2
c         NPOI2=NPOI2+1
c         PROPS(NPOI2)=PARAM(I)
c        ENDDO
c       ENDDO
c       WRITE(LURES,823)
c       DO IPROP=NPOI1+1,NPOI2,2
c        WRITE(LURES,804) PROPS(IPROP),PROPS(IPROP+1)
c       ENDDO
c       WRITE(LURES,899)
c      ELSE
c       CALL RUNEND('PROPIVT: A_COEFFICIENT CARD NOT FOUND')
c      ENDIF
C
C**** COEFFICIENT B
C
c      NPRIN=0
c      CALL LISTEN('PROPIVT',NPRIN,ITAPE)
c      IF(WORDS(1).EQ.'B_COE') THEN
c       NPOI1=NPOI2+1
c       NPOI2=NPOI1
c       PROPS(NPOI1)=PARAM(1)
c       NLINE=INT(PARAM(1))
c       IF(NLINE.GT.20)
c    .   CALL RUNEND('ERROR: WRONG NUMBER OF POINTS IN B_COEF')
c       NPRIN=1
c       DO LINEA=1,NLINE
c        CALL LISTEN('PROPIVT',NPRIN,ITAPE)
c        DO I=1,2
...
c       WRITE(LURES,899)
c      ELSE
c       CALL RUNEND('PROPIVT: B_COEFFICIENT CARD NOT FOUND')
c      ENDIF
C
C**** COEFFICIENT C
C
c      NPRIN=0
c      CALL LISTEN('PROPIVT',NPRIN,ITAPE)
c      IF(WORDS(1).EQ.'C_COE') THEN
c       NPOI1=NPOI2+1
c       NPOI2=NPOI1
c       PROPS(NPOI1)=PARAM(1)
c       NLINE=INT(PARAM(1))
c       IF(NLINE.GT.20)
c    .   CALL RUNEND('ERROR: WRONG NUMBER OF POINTS IN C_COEF')
c       NPRIN=1
c       DO LINEA=1,NLINE
c        CALL LISTEN('PROPIVT',NPRIN,ITAPE)
c        DO I=1,2
...
c       WRITE(LURES,899)
c      ELSE
c       CALL RUNEND('PROPIVT: C_COEFFICIENT CARD NOT FOUND')
c      ENDIF
C
c      CALL RUNMEN('WARNING: ZABARAS LAW USES ZERO THERMAL HD FUNCTION &
c    . ZERO HD COEFFICIENTS')
C
c     ENDIF           ! ivifl.eq.4
C
...
C
     ...
     .   CALL RUNEND('PROPIVN: EXPONENT LE 0.0')
       ELSE
        CALL RUNEND('PROPIVN: EXPONENT CARD NOT FOUND')
       ENDIF
      ENDIF           ! ivifl.eq.1.or.ivifl.eq.2.or. ...
C
...
C
       ...
       IF(WORDS(1).EQ.'A_COE') THEN
        ...
        WRITE(LURES,899)
       ELSE
        CALL RUNEND('PROPIVN: A_COEFFICIENT CARD NOT FOUND')
       ENDIF
C
C**** COEFFICIENT B
C
       ...
       IF(WORDS(1).EQ.'B_COE') THEN
        ...
        WRITE(LURES,899)
       ELSE
        CALL RUNEND('PROPIVN: B_COEFFICIENT CARD NOT FOUND')
       ENDIF
C
C**** COEFFICIENT C
C
       ...
       IF(WORDS(1).EQ.'C_COE') THEN
        ...
        WRITE(LURES,899)
       ELSE
        CALL RUNEND('PROPIVN: C_COEFFICIENT CARD NOT FOUND')
       ENDIF
      ENDIF           ! ivifl.eq.7
C
...
C
    ...
    5 IF(WORDS(1).EQ.'YIELD') THEN
     ...
     .    CALL RUNEND('ERROR IN VERSION OF GURSON YIELD CRIT.')
       ...
       ENDIF
       IF(IAUXX.EQ.0)
     .  CALL RUNEND('PROPIVN: WRONG YIELD FUNCTION         ')
      ELSE
       CALL RUNEND('PROPIVN: YIELD FUNCTION CARD NOT FOUND')
      ENDIF
C
...
C
     ...
     .    CALL RUNEND('ERROR IN VERSION OF GURSON FLOW POT.')
       ...
       ENDIF
       IF(IAUXX.EQ.0)
     .  CALL RUNEND('PROPIVN: WRONG FLOW POTENTIAL FUNCTION         ')
      ELSE
       CALL RUNEND('PROPIVN: FLOW_POTENTIAL CARD NOT FOUND')
      ENDIF
C
...
C
         IF(IIAUX.EQ.4) THEN
          ...
          IF(WORDS(1).EQ.'Q1_PA') THEN
           ...
           WRITE(LURES,899)
          ELSE
           CALL RUNEND('PROPIVN: Q1_PARAMETER CARD NOT FOUND')
          ENDIF
         ENDIF
C
...
C
         IF(IIAUX.EQ.4) THEN
          ...
          IF(WORDS(1).EQ.'Q2_PA') THEN
           ...
           WRITE(LURES,899)
          ELSE
           CALL RUNEND('PROPIVN: Q2_PARAMETER CARD NOT FOUND')
          ENDIF
         ENDIF
        ELSE
...
C
    ...
    6 IF(WORDS(1).EQ.'DAMAG') THEN
     ...
     .   CALL RUNEND('PROPIVN: WRONG DAMAGE MODEL')
...
C
        ...
        IF(WORDS(1).EQ.'DAMAG') THEN
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: COEFFICIENT DAMAGE_P_A CARD NOT FOUND')
        ENDIF
       ENDIF                  ! idamg.eq.1.or.idamg.eq.2
C
       IF(IDAMG.EQ.3) THEN

        call runend('ERROR: idamg=3 not implemented yet in propivn.f')
...
c        WRITE(LURES,839)
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: COEFFICIENT B9 CARD NOT FOUND')
        ENDIF
       ENDIF                  ! idamg.eq.3
C
...
C
        ...
        IF(WORDS(1).EQ.'EPSIL') THEN
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: COEFFICIENT EPSILON_D CARD NOT FOUND')
        ENDIF
C
...
C
        ...
        IF(WORDS(1).EQ.'EPSIL') THEN
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: COEFFICIENT EPSILON_R CARD NOT FOUND')
        ENDIF
C
...
C
        ...
        IF(WORDS(1).EQ.'CRITI') THEN
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: CRITICAL_DAMAGE CARD NOT FOUND')
        ENDIF
C
...
C
        ...
        IF(WORDS(1).EQ.'S_PAR') THEN
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: COEFFICIENT S_PARAMETER CARD NOT FOUND')
        ENDIF
C
...
C
        ...
        IF(WORDS(1).EQ.'S_EXP') THEN
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: COEFFICIENT S_EXPONENT CARD NOT FOUND')
        ENDIF
C
...
C
        ...
        IF(WORDS(1).EQ.'A_PAR') THEN
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: A_PARAMETERS CARD NOT FOUND')
        ENDIF
C
C**** LOOK FOR 'FINAL_DAMAGE_PARAMETER' CARD
C
...
C
       IF(IDAMG.EQ.21) THEN
        ...
        IF(WORDS(1).EQ.'GAMMA') THEN
         ...
         WRITE(LURES,899)
        ELSE
         CALL RUNEND('PROPIVN: GAMMA PARAMETERS NOT FOUND')
        ENDIF
       ENDIF
      ELSE
       NPOI1=NPOI2+1
...
C
        IF(IFATM.GE.2) THEN
         CALL RUNEND('PROPIVN: IFATM GT 2')
        ENDIF
       ELSE
        CALL RUNEND('PROPIVN: FATIGUE_MODEL CARD NOT FOUND')
       ENDIF
      ELSE
       GO TO 9
      ENDIF
...
C
    ...
    9 IF(WORDS(1).NE.'END_M')
     . CALL RUNEND('PROPIVN: END_MATERIAL CARD NOT FOUND   ')
      WRITE(LURES,899)
C
...
C
      IF(NPOI2.GT.NPROP) THEN
       ...
       CALL RUNEND('PROPIVN: TOO MANY PROPERTIES TO READ')
      ENDIF
C
      RETURN
  ...
  808 FORMAT(/,'  VISCOSITY             =',E15.6,/)
  809 FORMAT(/,'  EXPONENT              =',E15.6,/)
