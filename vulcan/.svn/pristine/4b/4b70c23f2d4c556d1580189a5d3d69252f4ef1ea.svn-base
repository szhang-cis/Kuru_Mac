      SUBROUTINE FRMX05T(CARTDT,DVOLUT,EHISTT,ELCODT,ELDIST,EPMTXT,
...
C     ( FOR ELEMENT NO. 5 )
C
C     Note: this routine should be improved to deal with subelements
C           (IEGFPC=1, NMEMO3=0 & MULPHT=1). It is necessary to define
C           ELCOD & ELDIS at "internal nodes" (SHAPE & CARTD both
C           defined considering such nodes are also necessary inside the
C           subelement)
C
C***********************************************************************
...
C
      GOTO(1,2,3), NDIMET
C
    1 CALL FRMX1DT(CARTDT,DVOLUT,EHISTT,ELCODT,ELDIST,EPMTXT,
     .             GPCODT,LNODST,PROPST,RMAT1T,SHAPET,STRANT,
     .             STRSGT,STRA0T,STRS0T,
     .             BMSIGT,BMATXT,DESIGT,DMATXT,DSTRAT,PRESGT,
     .             SGTOTT,SIGMAT,TSTRAT,XJACMT,ELELTT,VELCMT,
     ...
     .             TEINIT,FPCHLT)
      RETURN
C
    2 CALL FRMX2DT(CARTDT,DVOLUT,EHISTT,ELCODT,ELDIST,EPMTXT,
     .             GPCODT,LNODST,PROPST,RMAT1T,SHAPET,STRANT,
     .             STRSGT,STRA0T,STRS0T,
     .             BMSIGT,BMATXT,DESIGT,DMATXT,DSTRAT,PRESGT,
     .             SGTOTT,SIGMAT,TSTRAT,XJACMT,ELELTT,VELCMT,
     ...
     .             TEINIT,FPCHLT)
      RETURN
C
    3 CALL FRMX3DT(CARTDT,DVOLUT,EHISTT,ELCODT,ELDIST,EPMTXT,
     .             GPCODT,LNODST,PROPST,RMAT1T,SHAPET,STRANT,
     .             STRSGT,STRA0T,STRS0T,
     .             BMSIGT,BMATXT,DESIGT,DMATXT,DSTRAT,PRESGT,
     .             SGTOTT,SIGMAT,TSTRAT,XJACMT,ELELTT,VELCMT,
