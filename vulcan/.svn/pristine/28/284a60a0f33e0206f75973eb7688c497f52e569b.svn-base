      SUBROUTINE FRMC2DT(CARTDT,DVOLUT,EHISTT,ELCODT,ELDIST,EPMTXT,
       ...
       do ic=1,2
        ...
        do ir=1,nrr
         ...
         do is=1,nrr-ir+1
          ...
          CALL PHCC10T(CARTDT,DVOLUT,EHISTT,ELCODT,ELDIST,EPMTXT,
     .                 GPCODT,LNODST,PROPST,RMAT1T,SHAPET,STRANT,
     .                 STRSGT,STRA0T,STRS0T,
     .                 BMSIGT,BMATXT,DESIGT,DMATXT,DSTRAT,PRESGT,
     .                 SGTOTT,SIGMAT,TSTRAT,XJACMT,ELELTT,VELCMT,
      ...
      IF(NNODLT.EQ.4) THEN
       ...
       do ir=1,nr
        ...
        do is=1,ns
         ...
         CALL PHCC05T(CARTDT,DVOLUT,EHISTT,ELCODT,ELDIST,EPMTXT,
     .                GPCODT,LNODST,PROPST,RMAT1T,SHAPET,STRANT,
     .                STRSGT,STRA0T,STRS0T,
     .                BMSIGT,BMATXT,DESIGT,DMATXT,DSTRAT,PRESGT,
     .                SGTOTT,SIGMAT,TSTRAT,XJACMT,ELELTT,VELCMT,
