...
C**** OUTPUT & OUTPUTT
C
      INTEGER*4       ITERMEF,ISTAGF,ITERMPF,KTEM1F
C
      COMMON/COSTAFAF/ITERMEF,ISTAGF,ITERMPF,KTEM1F
C--------------------------------------------------------------- NUEVOSF
C**** ELEMENT
C
...
C
      REAL*8         GRATEFF,TREFEFF,
     .               GRAVYFF,GVECTFF(3),FPARATT(20),
     .               VISC1F,VISC2F,DILA1F,DILA2F,
     .               TFACTF
C
      COMMON/COUPMAT/GRATEFF,TREFEFF,
     .               GRAVYFF,GVECTFF,FPARATT,
     .               VISC1F,VISC2F,DILA1F,DILA2F,
     .               TFACTF
C
...
C--------------------------------------------------------------- NUEVOSF
C**** LIQUID-SOLID PHASE-CHANGE
C
      INTEGER*4      ILSPCF,ISOLIF
C
      COMMON/LSPCFLO/ILSPCF,ISOLIF
C--------------------------------------------------------------- NUEVOSF
